...
file_default - имя файла данных. 

Для проверки раскомментировать нужную функцию в файле func.py. и запустить файл.
Находясь в корне директории с файлом запустить команду `python func.py`
